...
#define NANDRW_YAFFS	0x08    /* to write yaffs image, www.txmcu.com */
 ...
 *  Change By www.txmcu.com, if ecc_code is null, write without ECC
 */
			    ...
			    int page, int col, int last, u_char * ecc_code)
{
    ...
    /* if ecc_code is null, write without ecc, www.txmcu.com */
